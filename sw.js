...
function patchIndex(html) {
  ...
  html = html.replace(
    ...
    block([
      "// Keine Route gefunden – trotzdem Airline und Flugzeugtyp anzeigen, wenn erkennbar",
      "    const airline = airlineName(ac);",
